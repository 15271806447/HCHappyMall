        ...
        if (res.code) {
          ...
          wx.request({
            ...
            success: function(res) {
              ...
              app.globalData.openid = res.data.data.oid;
              console.log(getApp());
              wx.request({
      ...
      success: function(res) {
        ...
        for (var i = 0; i < TotalList.length; i++) {
          if (TotalList[i].firstClassifyId == firstClassifyList[0]) {
            ...
            BookItem[x].ProductImgUrl = app.globalData.url + '/common/file/showPicture.do?id=' + TotalList[i].productCovermap;
          ...
          if (TotalList[i].firstClassifyId == firstClassifyList[1]) {
            ...
            AudioItem[y].ProductImgUrl = app.globalData.url + '/common/file/showPicture.do?id=' + TotalList[i].productCovermap;
            AudioItem[y++].ProductId = TotalList[i].id;
          }
          if (TotalList[i].firstClassifyId == firstClassifyList[3]) {
            ...
            VideoItem[z].ProductImgUrl = app.globalData.url + '/common/file/showPicture.do?id=' + TotalList[i].productCovermap;
    ...
    wx.request({
      ...
      success: function(res) {
        ...
        for (let i = 0; i < carouselList.length; i++) {
          imgUrls[i] = app.globalData.url + '/common/file/showPicture.do?id=' + carouselList[i].path;
        }
        that.setData({
          'imgUrls': imgUrls
        })
